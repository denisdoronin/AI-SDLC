...
9. **Report** — return a final summary to the developer: what was done, what remains for human review.
...
`[JIRA-key] → Design: ok/skip → Code: done → Tests: N passed → Lint: clean → PR: <link> → CI: pending/green/red`
